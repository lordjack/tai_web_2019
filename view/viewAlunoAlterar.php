<?php
    ...
    if( !empty($_POST['form_submit']) ) {
      ...
      $objAluno = modeloAluno::findAluno($_GET['id']);
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container theme-showcase" role="main">
        ...
        <form class="form" method="post" action="viewAlunoAlterar.php">
            ...
            <div class='row'>
                <div class="col-sm-6">
                    <label>Nome: </label>
                    <input type="text" name="nome" value="<?php echo $objAluno->nome; ?>" class="form-control">
                </div>
                <div class="col-sm-3">
                    <label>Curso: </label>
                    <input type="text" name="curso" value="<?php echo $objAluno->curso; ?>" class="form-control">
                </div>
                <div class="col-sm-3">
                    <label>Turma: </label>
                    <input type="text" name="turma" value="<?php echo $objAluno->turma; ?>" class="form-control">
                </div>
            </div>
            <br>
